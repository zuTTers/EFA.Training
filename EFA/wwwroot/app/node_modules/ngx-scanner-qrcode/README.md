...
It is recommended to declare it in the head of index.html
...
| [deviceActive]| device index                  | number                    | 0               |
| [constraints] | setting video                 | MediaStreamConstraints    | ``` {audio:false,video:true} ``` |
| [config]      | config                        | ScannerQRCodeConfig       | ``` {src:...,fps...,vibrate...,decode:...,isBeep:...,deviceActive...,config:...,constraints:...} ``` |
