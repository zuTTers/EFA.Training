...
export declare class NgxScannerQrcodeComponent implements OnInit, OnDestroy {
    ...
    deviceActive: number | undefined;
    config: ScannerQRCodeConfig;
    constraints: MediaStreamConstraints | any | undefined;
    /**
     * Export
     */
    isStart: boolean;
     ...
     * @return AsyncSubject
     */
    applyConstraints(constraints: MediaTrackConstraintSet | any): AsyncSubject<any>;
    /**
     * getConstraints
     * @param deviceActive
     * @returns
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NgxScannerQrcodeComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NgxScannerQrcodeComponent, "ngx-scanner-qrcode", ["scanner"], { "src": "src"; "fps": "fps"; "vibrate": "vibrate"; "decode": "decode"; "isBeep": "isBeep"; "deviceActive": "deviceActive"; "config": "config"; "constraints": "constraints"; }, { "event": "event"; }, never, never>;
}

//# sourceMappingURL=ngx-scanner-qrcode.component.d.ts.map