(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-scanner-qrcode', ['exports', 'rxjs', '@angular/core'], factory) :
    (factory((global['ngx-scanner-qrcode'] = {}),global.rxjs,global.ng.core));
    ...
    ***************************************************************************** */
    ...
    var NgxScannerQrcodeComponent = /** @class */ (function () {
         ...
         */
            function (fileName) {
                var _this = this;
                if (fileName === void 0) {
                    fileName = "ngx-scanner-qrcode-" + Date.now() + ".png";
                }
                /** @type {?} */
                var as = new rxjs.AsyncSubject();
                /** @type {?} */
    ...
    exports.ScannerQRCodeSymbolType = ScannerQRCodeSymbolType;
    exports.ScannerQRCodeConfigType = ScannerQRCodeConfigType;
    exports.ScannerQRCodeOrientation = ScannerQRCodeOrientation;
    exports.ScannerQRCodeResult = ScannerQRCodeResult;
